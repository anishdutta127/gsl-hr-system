...
export function TaskChecklist({
  ...
  // Sort by template's order in the templates list, then by dueDate.
...
function Row({
  ...
  task: TaskRow
  tpl: OnboardingTaskTemplate | undefined
  users: UserRef[]
  ...
  async function save() {
    ...
    try {
      ...
      const res = await fetch(`/api/admin/onboarding/tasks/${encodeURIComponent(task.id)}`, {
        method: 'PATCH',
